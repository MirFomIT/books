        ...
        <div class="row">
            ...
            <form method="POST" action="https://www.liqpay.ua/api/3/checkout" accept-charset="utf-8" target="_blank">
                ...
                Modal::begin([
                    ...
                    'toggleButton' => [
                        'label' => 'скачать книгу в pdf формате',
                        'tag' => 'button',
                        'class' => 'col-12 col-xs-4 col-sm-5 col-md-5 col-lg-5  btn buy_pdf',
                    ],
                    'footer' => '<p>При скачивании книги в pdf формате Вам на почту
                    будет отправлено сообщение об оплате через платёжную систему
                    <a href="https://www.liqpay.ua/ru" target="_blank">LiqPay</a></p>',
                ]);
                ?>
                ...
                <div class="col-xs-8 col-xs-offset-2 col-lg-8 col-lg-offset-2">
                    ...
                    <?= $form->field($user_new, 'first_name')->textInput(['autofocus' => true,'placeholder'=>'Имя'])->label('') ?>

                    <?= $form->field($user_new, 'email')->textInput(['placeholder'=>'E-mail'])->label('') ?>

                </div>

                <div class="form-group">
                    <button class="btn buy_pdf">
                        <a>
